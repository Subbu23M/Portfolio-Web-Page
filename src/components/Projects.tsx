  ...
  const projects = [
    {
      ...
      technologies: technologies: ["React", "Node.js", "MongoDB", "Redux-Toolkit", "JWT", "Material-UI","Lazy Loading","Code Splitting","React Fragmen","Local Storage","Protected Routes"],
